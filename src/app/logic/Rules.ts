...
export function isTileOccupied(position : Position, boardState: Piece[]): boolean {
  ...
  export function isTileEmptyOrOccupiedByOpponent(position: Position, boardState: Piece[], team: TeamType): boolean{
